...
const { ANVIL_FORK_URL, ALCHEMY_API_KEY, FORK_BLOCK } = process.env;
...
module.exports = {
  ...
  networks: {
    ...
    hardhat: {
      chainId: 1,
      // Strictly require a fork when using hardhat network
      forking: {
        url: ANVIL_FORK_URL || (ALCHEMY_API_KEY ? `https://eth-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}` : DEFAULT_ANKR),
